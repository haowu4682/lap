...
void mcpat_initialize(root_system *sys);
void print_mcpat_config(root_system *sys);
void mcpat_set_config(root_system *sys, std::string fileName);
void print_mcpat_stats(root_system *sys);
double mcpat_compute_percycle_power(root_system *sys);
void mcpat_display_core(root_system *sys);
double mcpat_get_area(root_system *sys);
void mcpat_get_TDP(root_system *sys, double *core, double *uncore);
void dumpCoreEnergy(root_system *sys);
void mcpat_flush_data(void);
void mcpat_closefile(void);

#if 0
void initialize_sys(root_system *sys);
void initialize_config(root_system *sys);
void save(void);
#endif
